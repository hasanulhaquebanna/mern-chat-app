    ...
    <div className="relative flex flex-col items-center justify-center w-full h-screen">
      ...
      <div className="flex p-16 mt-[45px] w-[800px] h-[450px] bg-white shadow-formContainer rounded-[30px]">
        ...
        <div className="flex flex-col items-center justify-center flex-2">
          <h2 className="text-[25px] font-normal text-primaryGray mb-[30px]">
            Create Account
          </h2>
          <input
            type="text"
            className="w-[320px] h-[35px] p-[5px] my-[5px] mx-0 outline-none border border-primaryBorder rounded-[5px] text-[13px]"
          ...
          <input
            ...
            onChange={handleInput}
          />
          <div className="w-[320px] h-[30px] p-[5px] my-[5px] mx-0 flex items-center border-primaryBorder rounded-[5px] text-[13px] relative">
            <label
              htmlFor="file"
              className="w-[135px] text-primaryYellow font-semibold cursor-pointer"
            >
              Profile picture
            </label>
            <input
          ...
          <p className="text-sm text-primaryGray m-[5px] mx-0 p-0">or</p>
          <button
            className="w-[230px] h-10 rounded-[5px] border-none outline-none bg-white shadow-googleBtn text-base font-medium mt-0 mr-0 mb-5 ml-0 text-primaryGray pointer flex items-center justify-center relative p-1"
            onClick={googleAuth}
          >
            <img
          ...
          <p className="text-sm text-primaryGray m-[5px] mx-0 p-0">
